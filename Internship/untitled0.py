...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug 21 09:12:14 2018
...
from sklearn.mode_selection import TimeSeriesSplit
def timeseriesCVscore(params,series,loss_function = mean_squared_error, slen = 7):
    ...
    for train,test in tscv.split(values):
        ...
        predictions = mode.results[-len(test):]
        actual = values[test]
...
data = ads.Ads[:-20]
x = [0,0,0]
opt = minimize(timeseriesCVscore,x0=x,args = (data,mean_sqaured_error),methods = "TNC", bounds = ((0,1),(0,1),(0,1)))
